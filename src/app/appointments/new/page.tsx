...
const typeRef = useRef<HTMLDivElement | null>(null);
  ...
  function autoLinkifyPhonesInEditor() {
    if (typeof document === "undefined") return;
    const el = descEditorRef.current;
    if (!el) return;
    if (autoTelWorkingRef.current) return;
    ...
    autoTelWorkingRef.current = true;
    ...
    try {
      ...
      for (const tn of textNodes) {
        ...
        if (parentEl.closest("a")) continue; // nichts in Links verändern
        ...
        // Wenn wir nichts ersetzt haben, weiter
      ...
      autoTelLastHtmlRef.current = el.innerHTML ?? nextHtml;
